...
class Saver(BaseWorker):
    ...
    def saveImages(self, path: str, project: Project):
        ...
        project.alphaMatte().save(dir.filePath(project.alphaMatteName()), quality=quality)
        ...
        if project.newBackground() and project.newBackgroundName():
            project.newBackground().save(dir.filePath(project.newBackgroundName()), quality=quality)

...
class SpinBox(qtw.QSpinBox):
    ...
    def __init__(self, min:int, max:int, value:int, toolTip=None, specialValueText:str = None, wrapping=True, parent=None):
...
class DoubleSpinBox(qtw.QDoubleSpinBox):
    ...
    def __init__(self, min, max, value, decimals, step, toolTip=None, wrapping=True, parent=None):

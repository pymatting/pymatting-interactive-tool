...
class TestFileNameValidator(unittest.TestCase):
    ...
    def testFileNamesAcceptable(self):
        ...
        self.assertEqual(QValidator.Acceptable, validator.validate("023aaBc_Dwewq-qecsadWd23asfdse", 0)[0])
    ...
    def testFileNamesInvalid(self):
        ...
        self.assertEqual(QValidator.Invalid, validator.validate("023aaBc.Dwewq-qecsadWd23", 0)[0])
        self.assertEqual(QValidator.Invalid, validator.validate(".", 0)[0])
        self.assertEqual(QValidator.Invalid, validator.validate("?", 0)[0])
